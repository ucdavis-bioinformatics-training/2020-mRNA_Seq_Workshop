...
```{r Star.StarRaw, fig.width=8, fig.height=8, message=F, warning=F}
...
```{r Salmon.SalmonRaw, fig.width=8, fig.height=8, message=F, warning=F}
...
```{r StarRaw.Salmon, fig.width=8, fig.height=8, message=F, warning=F}
...
x = list(STAR.raw=rownames(DE.star.raw)[DE.star.raw$adj.P.Val < 0.05],
         ...
         STAR.cleaned=rownames(DE.salmon)[DE.salmon$adj.P.Val < 0.05])
ggVennDiagram(x)
```
...
x = list(STAR.raw=rownames(DE.star.raw)[1:100],
         ...
         STAR.cleaned=rownames(DE.salmon)[1:100])
ggVennDiagram(x)
```
